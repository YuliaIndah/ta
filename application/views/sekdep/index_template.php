          ...
          <aside>
            <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                <li class="">
                  <a class="" href="<?php echo site_url('SekdepC/')?>">
                ...
                <li class="sub-menu ">
                  <a href="javascript:;" class="">
                    ...
                    <span>Sek. Departemen</span>
                    <span class="menu-arrow arrow_carrot-right"></span>
                  </a>
                  <ul class="sub">
                    <li class=""><a class="" href="<?php echo site_url('SekdepC/pengajuan_kegiatan')?>">Pengajuan Kegiatan</a></li>                          
                ...
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                    <li><a class="" href="<?php echo site_url('SekdepC/pengajuan_kegiatan_pegawai')?>">Pengajuan Kegiatan</a></li>                          
                    <li><a class="" href="<?php echo site_url('SekdepC/kegiatan_pegawai')?>">Kegiatan</a></li>
                  </ul>
                </li>      
              </ul>
              <!-- sidebar menu end-->
